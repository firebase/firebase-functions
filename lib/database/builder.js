...
var DatabaseBuilder = (function () {
    ...
    DatabaseBuilder.prototype.on = function (event, handler) {
        ...
        console.warn('DEPRECATION NOTICE: database().on("write", handler) is deprecated, use datavase().onWrite(handler)');
