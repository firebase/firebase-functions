...
var DatabaseDeltaSnapshot = (function () {
    ...
    Object.defineProperty(DatabaseDeltaSnapshot.prototype, "ref", {
        get: function () {
            if (!this._ref) {
                this._ref = internal_1.default.apps.forMode(this._auth).database().ref(this._fullPath());
            }
            return this._ref;
        },
        enumerable: true,
    ...
    DatabaseDeltaSnapshot.prototype._dup = function (previous, childPath) {
        ...
        _a = [this._path, this._auth, this._data, this._delta, this._childPath, this._newData], dup._path = _a[0], dup._auth = _a[1], dup._data = _a[2], dup._delta = _a[3], dup._childPath = _a[4], dup._newData = _a[5];
        if (previous) {
