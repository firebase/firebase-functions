...
var FirebaseEvent = (function () {
    function FirebaseEvent(options) {
        _a = [options.service, options.type, options.instance, options.deviceId, options.data, options.params || {}, options.auth.variable], this.service = _a[0], this.type = _a[1], this.instance = _a[2], this.deviceId = _a[3], this.data = _a[4], this.params = _a[5], this.auth = _a[6];
